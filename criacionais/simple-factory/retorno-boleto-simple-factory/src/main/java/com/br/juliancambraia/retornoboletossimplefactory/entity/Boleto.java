package com.br.juliancambraia.retornoboletossimplefactory.entity;

import com.br.juliancambraia.retornoboletossimplefactory.model.LeituraBoleto;
...
public class Boleto {
    ...
    public String toString() {
        ...
        str += ag + String.format(
                ...
                LeituraBoleto.FORMATO_DATA.format(dataVencimento),
                LeituraBoleto.FORMATO_DATA_HORA.format(dataPagamento), valor);
        if (multa > 0) {
